...
public class GunAttackBehaviour : StateMachineBehaviour
{
	...
	{
		if(stateInfo.normalizedTime >0.1 && player.GetComponent<PlayerControler>().GetIsAttack())
		{
			player.GetComponent<Equipment> ()._weapon.GetComponent<Gun> ().characterTransform = player.transform;
			player.GetComponent<Equipment> ()._weapon.GetComponent<Gun> ().equipTransform = player.GetComponent<Equipment> ()._weapon.transform;
			player.GetComponent<Equipment> ()._weapon.GetComponent<Gun> ().Attack ();	
