...
public class HammerAttackBehaviour : StateMachineBehaviour
{
	...
	override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
	{
		...
		if (  player.GetComponent<PlayerControler> ().GetIsAttack ()) {
			...
			player.GetComponent<Equipment> ()._weapon.GetComponent<Hammer> ().characterTransform = player.transform;
			player.GetComponent<Equipment> ()._weapon.GetComponent<Hammer> ().Attack ();	
